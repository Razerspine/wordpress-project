...
<head>
    ...
    <link rel="icon" href="<?php echo esc_url(get_template_directory_uri() . '/assets/img/favicon.ico'); ?>"
          type="image/x-icon">
    <?php wp_head(); ?>
    <meta name="verify-admitad" content="0c405940ef" />
</head>
...
<div class="wrapper js-container"><!--Do not delete!-->
            ...
            <div class="header__wrapper">
                ...
                <div class="header__item">
                    <div class="header__field">
                        <img class="header__icon" src="/wp-content/themes/za-creditom/assets/img/award.svg" alt="icon">
                        Только лучшие компании.
                    </div>
                    <div class="header__field">
                        <img class="header__icon" src="/wp-content/themes/za-creditom/assets/img/notification_bell.svg"
                             alt="icon">
                        Актуальная информация.
                    </div>
                    <div class="header__field">
                        <img class="header__icon" src="/wp-content/themes/za-creditom/assets/img/dollar_sign.svg"
                             alt="icon">
                        Бесплатно для вас.
                    </div>
                </div>
    ...
    <!-- Mobile menu end-->
    */ ?>
    <script type="text/javascript" src="/wp-content/themes/za-creditom/assets/js/nouislider.min.js"></script>
